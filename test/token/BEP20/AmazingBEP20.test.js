...
const AmazingBEP20 = artifacts.require('AmazingBEP20');
const ServiceReceiver = artifacts.require('ServiceReceiver');

contract('AmazingBEP20', function ([owner, other, thirdParty]) {
  const _name = 'AmazingBEP20';
  const _symbol = 'BEP20';
  ...
  beforeEach(async function () {
    ...
    await this.serviceReceiver.setPrice('AmazingBEP20', fee);
  });

  context('creating valid token', function () {
    describe('as a AmazingBEP20', function () {
      describe('without initial supply', function () {
        beforeEach(async function () {
          this.token = await AmazingBEP20.new(
            _name,
            _symbol,
            _decimals,
            0,
  ...
  context('AmazingBEP20 token behaviours', function () {
    beforeEach(async function () {
      this.token = await AmazingBEP20.new(
        _name,
        _symbol,
    ...
    context('like a AmazingBEP20', function () {
